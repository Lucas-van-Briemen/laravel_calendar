...
<head>
    ...
    <style>
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url('https://fonts.gstatic.com/s/figtree/v6/_Xmz-HUzqDCFdgfMsYiV_F7wfS-Bs_d_QG5XyEY.woff') format('woff'), url('https://fonts.gstatic.com/s/figtree/v6/_Xmz-HUzqDCFdgfMsYiV_F7wfS-Bs_d_QG5XyEA.woff2') format('woff2');
        }
    </style>
    <!--<![endif]-->
    <!--[if mso]>
...
<body class="body pc-font-alt" style="width: 100% !important; min-height: 100% !important; margin: 0 !important; padding: 0 !important; line-height: 1.5; color: #2D3A41; mso-line-height-rule: exactly; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-variant-ligatures: normal; text-rendering: optimizeLegibility; -moz-osx-font-smoothing: grayscale; background-color: #111827;" bgcolor="#111827">
    <table class="pc-project-body" style="table-layout: fixed; min-width: 600px; background-color: #111827;" bgcolor="#111827" width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
        <tr>
                                            ...
                                            <tr>
                                                <td style="padding: 0px 0px 0px 0px;">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation" style="border-collapse: separate; border-spacing: 0px;">
                                                        <tr>
                                                            <td valign="top" class="pc-w520-padding-30-30-30-30 pc-w620-padding-35-35-35-35" style="padding: 40px 40px 40px 40px; border-radius: 32px 32px 32px 32px; background-color: #1f2937;" bgcolor="#1f2937">
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" align="left">
                                                                                        <div class="pc-font-alt" style="text-decoration: none;">
                                                                                            <div style="font-size:24px;line-height:34px;text-align:center;text-align-last:center;color:#fefefe;letter-spacing:-0.4px;font-weight:400;font-style:normal;font-variant-ligatures:normal;">
                                                                                                <div style="margin-bottom: 0px;"><span style="font-family: 'Figtree', Arial, Helvetica, sans-serif; font-size: 24px; line-height: 34px; text-decoration: none; text-transform: none;">{{ $agendaItem->title }}</span>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                            ...
                                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                                                                <tr>
                                                                                    <td valign="top" align="center">
                                                                                        <div class="pc-font-alt" style="text-decoration: none;">
                                                                                            <div style="font-size:18px;line-height:28px;text-align:center;text-align-last:center;color:#9ca3af;letter-spacing:-0.2px;font-weight:400;font-style:normal;font-variant-ligatures:normal;">
                                                                                                <div style="margin-bottom: 0px;"><span style="font-family: 'Figtree', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 28px; text-decoration: none; text-transform: none;" class="pc-w620-font-size-16px pc-w620-line-height-26px">{{ $agendaItem->description }}</span>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                ...
                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td align="center" valign="top" style="padding: 0px 0px 42px 0px;">
                                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                                                                                <tr>
                                                                                    <td valign="top" align="center">
                                                                                        <div class="pc-font-alt" style="text-decoration: none;">
                                                                                            <div style="font-size:18px;line-height:28px;text-align:center;text-align-last:center;color:#9ca3af;letter-spacing:-0.2px;font-weight:400;font-style:normal;font-variant-ligatures:normal;">
                                                                                                <div style="margin-bottom: 0px;"><span style="font-family: 'Figtree', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 28px; text-decoration: none; text-transform: none;" class="pc-w620-font-size-16px pc-w620-line-height-26px">You have an event comming up at: {{ $agendaItem->start }}</span>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
